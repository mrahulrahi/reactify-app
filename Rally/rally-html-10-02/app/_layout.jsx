...
export default function Layout() {
  ...
  return (
    <Stack screenOptions={{ headerShown: false }}>
      <Stack.Screen name="auth/index" options={{ title: "Create Account" }} />
      <Stack.Screen name="auth/signup" options={{ title: "Signup" }} />
      <Stack.Screen name="auth/signin" options={{ title: "Signin" }} />
      <Stack.Screen name="auth/otp-verification" options={{ title: "OTP Verification" }} />
      <Stack.Screen name="auth/password-success" options={{ title: "Password Success" }} />
    </Stack>
  );
}
