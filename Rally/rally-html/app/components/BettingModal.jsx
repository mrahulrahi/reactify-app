          ...
          <View className="w-full bg-modal-bg-color rounded-t-lg overflow-hidden">
            ...
            >
              <View className="flex-row justify-between items-center px-5 pt-2.5 pb-[13px]">
                ...
                <TouchableOpacity activeOpacity={1} onPress={() => setIsSubmitted(false)}>
                  <Feather name="chevron-down" size={24} color="white" />
                </TouchableOpacity>
              </View>
            </LinearGradient>
          ...
          <View className="w-full bg-modal-bg-color rounded-t-lg overflow-hidden">
            ...
            >
              <View className="flex-row justify-between items-center px-5 pt-2.5 pb-[13px]">
                ...
                <TouchableOpacity activeOpacity={1} onPress={onClose2}>
                  <Feather name="chevron-down" size={24} color="white" />
                </TouchableOpacity>
              </View>
            </LinearGradient>
          ...
          <View className="w-full bg-modal-bg-color rounded-t-lg overflow-hidden">
            ...
            >
              <View className="flex-row justify-between items-center px-5 pt-2.5 pb-[13px]">
                ...
                <TouchableOpacity activeOpacity={1} onPress={() => setIsSubmitted2(false)}>
                  <Feather name="chevron-down" size={24} color="white" />
                </TouchableOpacity>
              </View>
            </LinearGradient>
          ...
          <View className="w-full bg-modal-bg-color rounded-t-lg overflow-hidden">
            ...
            >
              <View className="flex-row justify-between items-center px-5 pt-2.5 pb-[13px]">
                ...
                <TouchableOpacity activeOpacity={1} onPress={onClose3}>
                  <Feather name="chevron-down" size={24} color="white" />
                </TouchableOpacity>
              </View>
            </LinearGradient>
          ...
          <View className="w-full bg-modal-bg-color rounded-t-lg overflow-hidden">
            ...
            >
              <View className="flex-row justify-between items-center px-5 pt-2.5 pb-[13px]">
                ...
                <TouchableOpacity activeOpacity={1} onPress={() => setIsSubmitted3(false)}>
                  <Feather name="chevron-down" size={24} color="white" />
                </TouchableOpacity>
              </View>
            </LinearGradient>
