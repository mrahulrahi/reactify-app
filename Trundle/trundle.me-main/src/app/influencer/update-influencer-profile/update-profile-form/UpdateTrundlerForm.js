               ...
               <div className="upload-profile-box mb-4 d-flex flex-column align-items-center justify-content-center">
                  ...
                  {imagePreview ? (
                     <label
                        ...
                        className={`upload-profile-img d-flex justify-content-center ${imagePreview && `border-0`
                           }  cursor-pointer`}
                     >
                        <div
                           className={`${imagePreview ? `user-img` : `user-icon`
                              } `}
                        >
                           {imagePreview ? (
                              <Image
                     ...
                     <label
                        htmlFor="upload-profile"
                        className={`upload-profile-img d-flex justify-content-center cursor-pointer border-0`}
                     >
         ...
         <div className="row g-3">
            <div className="col-lg-12">
               <div className="form-group mb-4">
                  ...
                  <input
                     value={trundlerProfile?.data?.username}
                     className="form-control"
                     disabled
                  />
                  <ErrorMessage
