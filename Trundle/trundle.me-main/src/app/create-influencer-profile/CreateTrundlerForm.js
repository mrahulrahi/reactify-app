...
import { getAllCountries, getCoverCountries } from "../store/slices/countries";
...
const youtubeRegex = /^(https?:\/\/)?(www\.)?(youtube\.com\/(channel\/(?:UC[\w-]{21}[AQgw]|(c\/|user\/)?[^#\n]{1,}|(?:[a-zA-Z0-9_-]{5,})))|(youtu\.be\/(?:watch\?v=)?([\w-]{11})))$/;

const instagramRegex = /^(https?:\/\/)?(www\.)?(instagram\.com\/(p\/[\w-]+\/?)|(stories\/[\w-]+\/?)|([\w-]+\/?))$/;
...
const validationSchema = Yup.object().shape({
  ...
  youtube_link: Yup.string()
    .matches(youtubeRegex, "Invalid YouTube URL. Must be a valid YouTube URL.")
    .required("YouTube link is required"),
  instagram_link: Yup.string()
    .matches(instagramRegex, "Invalid Instagram URL. Must be a valid Instagram URL.")
...
const CreateYourProfilePage = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (event) => {
      ...
      formData.append("phone_code", parseInt(event?.phone_code));
      if (event?.languages) {
    ...
    <>
      ...
      <MidContainer>
        <div className="profile-form-container">
            ...
            <div className="col-lg-4 mx-auto">
              ...
              {imagePreview ? (
                ...
                <div className="upload-profile-box mb-4 d-flex flex-column align-items-center justify-content-center">
                  ...
                  <label
                    htmlFor="upload-profile"
                    className="upload-profile-img d-flex justify-content-center cursor-pointer"
                  >
          ...
          <div className="row g-3">
            <div className="col-lg-12 trundler-country-dropdown">
              <SelectField
              ...
              <div className="form-group mb-4">
                ...
                {formik?.values?.languages?.map((_, index) => (
                  <div className="row g-3 mb-2" key={index}>
                    <div className="col-6 trundler-langauges-dropdown-one">
                      <SelectField
                        className="form-select-container"
                        classNamePrefix="form-select"
                    ...
                    <div className="col-6 trundler-langauges-dropdown-two">
                      <SelectField
                        className="form-select-container"
                        classNamePrefix="form-select"
          ...
          <div className="row g-3">
            <div className="col-lg-12">
              <div className="form-group mb-4 trundler-cover-countries-dropdown">
                <SelectField
