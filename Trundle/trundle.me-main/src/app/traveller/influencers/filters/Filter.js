...
export default function Filter({ countriesList }) {
   ...
   const handleCityChange = (event) => {
      ...
      // createQueryString("cities", [...selectedCities, citySlug]);
   };
   ...
   const handlePriceChange = (event) => {
      ...
      createQueryString("price", priceId);
   };

   const handleDiscountRangeChange = (event) => {
      const discountRangeId = event.target.id;
      setSelectedDiscountRange(discountRangeId);
      createQueryString("discountRange", discountRangeId);
   };
         ...
         <div className="filter-sort-btn-box d-flex">
            <div className="fs-btn">
               <FilterButton
                  ...
                  _handleDiscountRangeChange={handleDiscountRangeChange}
