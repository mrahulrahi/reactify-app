...
export default function HomePageContent() {
  ...
  const whatsAppNavUrl = "https://wa.me/9884061496"
            ...
            <div className="row">
              <div className="col-lg-12">
                ...
                <div className="lpj-hero-cta d-flex justify-content-center">
                  <Link href={whatsAppNavUrl} target='_blank' className="btn btn-orange btn-lg">Talk to a Travel Expert</Link>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              <div className="col-lg-10 mx-auto">
                <div className="lpj-benefit-content text-center">
                  ...
                  <Link href={whatsAppNavUrl} target='_blank' className="btn btn-white">Talk to us</Link>
                </div>
              </div>
            </div>
          </div>
