...
import { getPriceList, getPurchasedItineraries } from "../../lib/itinerary/getItinerary"
...
const MyItineraries = async ({ searchParams }) => {
   ...
   const filteredPriceList = priceList?.priceList?.filter(item => parseInt(item.price) !== 0);
