...
import '../form.css'
import '../create-itinerary/CreateItinerary.css'
import Image from 'next/image'
import heroImg from './itinerary-hero.jpg'
...
const EditItineraryPage = () => {
    ...
    const [title, setTitle] = useState('Best place to visit in Osaka');
    const [discountCode, setDiscountCode] = useState('R10N10');
                    ...
                    <div className="row">
                        <div className="col-xl-10 mx-auto">
                            <div className="itinerary-form-container">
                                <div className="table-form-heading">View Itinerary</div>
                                <div className="upload-cover-img mb-4"><Image src={heroImg} fill alt="hero img" sizes="100VW" /></div>
                                        ...
                                        <div className="form-group d-flex align-items-center justify-content-center">
                                            ...
                                            <div className="form-group-right">
                                                <select className="form-select type2">
                                                    ...
                                                    <option>Traveller 2</option>
                                                    <option>Traveller 3</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="place-list-outer">
                                    ...
                                    <ul className="place-list position-relative">
                                        ...
                                        <li className="place-item position-relative">
                                            <button className="add-btn d-flex align-items-center justify-content-center" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight">
                                ...
                                <div className="col-lg-6 mx-auto mt-4">
                                    <button type="button" className="btn btn-default btn-block" >Publish</button>
                                </div>
                            </div>
                        </div>
                    </div>
