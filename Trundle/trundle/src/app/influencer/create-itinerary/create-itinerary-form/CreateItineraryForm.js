      ...
      onSubmit: async (itinerary) => {
         ...
         addedItineraryList.forEach((singleItinerary, index) => {
            for (const key in singleItinerary) {
               if (key === "post_code" && singleItinerary[key] === "") {
                  continue; // Skip appending if post_code value is an empty string
               }
         ...
         if (!itineraryListErr) {
            ...
            if (res?.payload?.status === true) {
               ...
               await dispatch(setAffiliateTitle(''));
                                 ...
                                 <div className="form-group d-flex align-items-center justify-content-center">
                                    ...
                                    <div className="form-group-right d-flex flex-column">
                                       <input
                                          ...
                                          id="affiliate_title"
                                          onChange={(e) => {
                                             formik.setFieldValue('affiliate_title', e.target.value);
                                             dispatch(setAffiliateTitle(e.target.value))
                                          }} onBlur={formik.handleBlur}
                                          value={
                                       ...
                                       >
                                          {priceList?.priceList?.map((p, i) => (
                                             <div
                                                key={i}
                                                onClick={() => {
                                                   formik?.setFieldValue("price", p?.price);
