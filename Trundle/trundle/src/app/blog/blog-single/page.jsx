                                    ...
                                    <div className="breadcrumb-left">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb mb-0">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">10 hidden cafes in Kamakura</li>
                                            </ol>
                                        </nav>
                                    </div>
                            ...
                            <div className="row">
                                <div className="col-lg-10 mx-auto">
                                    <div className="blog-sh-content text-center mx-auto">
                                        <h1>10 hidden cafes in Kamakura</h1>
                                        <p>Discover the charm of Kamakura with our guide to 10 secret cafes that offer a cozy escape from the bustling streets. Each spot is a hidden gem, perfect for enjoying a cup of coffee or tea while soaking in the local atmosphere.</p>
                                        <div className="blog-date">Jan 25</div>
                                        <div className="blog-categories-row d-flex align-items-center justify-content-center flex-wrap gap-2">
                                            <div className="blog-category">Japan</div>
                                            <div className="blog-category">Cafe</div>
                                            <div className="blog-category">Kamakura</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-10 mx-auto mt-5">
                                    <div className="blog-single-img-outer">
                                        <div className="blog-single-img"><Image src="/images/japan/blog-single-img.jpg" alt="" fill /></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="row align-items-center justify-content-center">
                                <div className="col-lg-8 mx-auto">
                                    <div className="bs-content-wrapper">
                                        ...
                                        <p>Kamakura, a charming coastal city in Japan, is not only known for its historical sites and beautiful beaches but also for its delightful cafes. With a rich blend of traditional and modern influences, the cafe culture in Kamakura offers a unique experience for both locals and tourists alike. In this blog post, we will explore some of the best cafes in Kamakura that you must visit.</p>
