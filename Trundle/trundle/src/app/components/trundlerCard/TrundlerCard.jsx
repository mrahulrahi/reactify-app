         ...
         <div className="trundler-card-box w-100 h-100 d-flex overflow-hidden position-relative">
            <div className="trundler-card-inside w-100 h-100 mt-auto d-flex flex-column">
               {trundlerDetails?.photo ?
                  ...
                  <div className="trundler-card-img mx-auto border-0">
                     <ProfilePlaceHolder
                        marginTop={0}
                        marginBottom={0}
                        width={90}
                        ...
                        name={`${trundlerDetails?.first_name} ${trundlerDetails?.last_name}`}
                        fontSize={13}
                     />
                  </div>
               }
               <Link
                  ...
                  <div className="d-flex flex-wrap gap-2 my-2 align-items-center justify-content-center">
