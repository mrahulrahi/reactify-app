...
const GenerationComplete = () => {
  ...
  const handleBadgePress = (badgeText) => {
    ...
    // Removed setIsInputFocused(false); to keep the keyboard open
  };
          ...
          <View className="h-20 p-4 flex-row justify-between border-0">
            ...
            <View className="flex-row gap-6">
              ...
              <TouchableOpacity
                ...
                className={`flex-row gap-1.5 items-center ${focusedIcon === "undo" ? "opacity-50" : "opacity-100"
                  }`}
              >
              ...
              <TouchableOpacity
                ...
                className={`flex-row gap-1.5 items-center ${focusedIcon === "redo" ? "opacity-50" : "opacity-100"
                  }`}
              >
                <View className="!w-[28px] !h-[28px] items-center justify-center flex-shrink-0">
                  <Image
          ...
          >
            <View className="w-full">
              <View className="grow justify-center">
                <View>
                  <GenRatioLogoCard aspectRatio="1/1" logoSource={images[id]} />
                </View>
              </View>
              {/* Action Buttons */}
              ...
              <TouchableWithoutFeedback>
                ...
                >
                  ...
                  >
                    ...
                    <View className="w-full h-[30px] pl-4 flex-row items-center justify-between">
                      <TouchableOpacity
            ...
            <View className="flex-col items-center">
              <View className="w-full max-w-[280px]">
                <Text className="font-inter700 text-[20px] leading-tight text-bs-white mb-7 text-center">
                  Share you Generation!
                </Text>

                <View className="flex-row justify-center gap-6 mb-7">
                  <Pressable>
                    <View className="w-[70px] h-[70px] flex-row items-center justify-center mb-2 bg-bs-black border border-[#454545] rounded-[24px]">
                      <Image
                        source={require("../../assets/images/share-icon-1.png")}
                        style={{ width: 34, height: 34 }}
                        contentFit="contain"
                        transition={1000} />
                    </View>
                    <Text className="font-inter500 text-[14px] leading-tight text-bs-white text-center">Message</Text>
                  </Pressable>
                  <Pressable>
                    <View className="w-[70px] h-[70px] mb-2 bg-bs-black border border-[#454545] rounded-[24px] items-center justify-center">
                      <Image
                        source={require("../../assets/images/share-icon-2.png")}
                        style={{ width: 34, height: 34 }}
                        contentFit="contain"
                        transition={1000} />
                    </View>
                    <Text className="font-inter500 text-[14px] leading-tight text-bs-white text-center">Instagram</Text>
                  </Pressable>
                  <Pressable>
                    <View className="w-[70px] h-[70px] mb-2 bg-bs-black border border-[#454545] rounded-[24px] items-center justify-center">
                      <Image
                        source={require("../../assets/images/share-icon-3.png")}
                        style={{ width: 34, height: 34 }}
                        contentFit="contain"
                        transition={1000} />
                    </View>
                    <Text className="font-inter500 text-[14px] leading-tight text-bs-white text-center">TikTok</Text>
                  </Pressable>
                </View>
                <View className="flex-col gap-6">
                  <Pressable activeOpacity={1}>
                    ...
                    >
                      <View className="flex-row items-center justify-center px-5 py-[18px] rounded-[50px] gap-2"
                      >
                        <Image
                          ...
                          contentFit="contain"
                          transition={1000} />
                        <Text className="font-inter700 text-[15px] leading-[18px] text-bs-white">
                          Download
                        </Text>
                      </View>
                    </LinearGradient>
